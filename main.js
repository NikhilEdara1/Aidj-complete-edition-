...
function draw(){
    ...
    if(scoreleftwrist > 0.2){
        ...
        rasplin=Number(leftwristy);
      Suutloops=floor(rasplin);
      nightchesire=Suutloops/500;
      document.getElementById("vc").innerHTML = "volume = "+nightchesire;
      console.log(nightchesire);
      song.setVolume(nightchesire);
    }
}
